...
@section('title', 'Peta KKPR - ' . $model->id)
...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-[#185B3C] via-[#0F3D26] to-[#185B3C] rounded-xl p-6 text-white">
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold mb-1">Peta KKPR #{{ $model->id }}</h1>
    ...
    <div class="flex flex-wrap gap-4">
        ...
        <a href="{{ route('member.kkpr.show', $model->id) }}" class="inline-flex items-center px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        console.log('Peta page initialized for KKPR #{{ $model->id }}');
    ...
    function loadKMLFromFolder() {
        setTimeout(function() {
            if(window.kkprMap) {
                // Try to load KML file first
                const kmlPath = '{{ url("uploads/berkas/kkpr/" . $model->id . "/kml/kml.kml") }}';
                        ...
                        if (geoJsonData && geoJsonData.features && geoJsonData.features.length > 0) {
                            ...
                            const geoJsonLayer = L.geoJSON(geoJsonData, {
                                ...
                                onEachFeature: function(feature, layer) {
                                    ...
                                    popupContent += `<br><strong>KKPR ID:</strong> {{ $model->id }}`;
    ...
    function loadExistingGeoJSONFromFolder() {
        const geoJsonPath = '{{ url("uploads/berkas/kkpr/" . $model->id . "/kml/geojson.geojson") }}';
                ...
                if(coordinates.length > 0) {
                    ...
                    const popupContent = `
                        <div class="text-center">
                            <strong>Area KKPR #{{ $model->id }}</strong><br>
    ...
    function loadExistingKML() {
        const geoJsonPath = '{{ url("uploads/berkas/kkpr/" . $model->id . "/kml/" . ($model->f_geojson ?? "")) }}';
    ...
    function loadExistingKMLFromKML() {
        ...
        @else
            console.log('No KML file found for this KKPR record');
        @endif
    }
