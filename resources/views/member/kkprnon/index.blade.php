...
@section('title', 'KKPR Non Usaha - Kelengkapan Kependudukan')
...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-[#185B3C] via-[#0F3D26] to-[#185B3C] rounded-xl p-6 text-white">
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold mb-1">KKPR Non Usaha</h1>
                    <p class="text-sm text-white/90 mb-4">Kelola semua permohonan KKPR Non Usaha Anda dengan mudah dan efisien</p>
    ...
    <div class="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <a href="{{ route('member.kkprnon.create') }}" class="group relative overflow-hidden bg-gradient-to-br from-[#185B3C] to-[#0F3D26] rounded-xl p-4 text-white hover:shadow-lg transition-all duration-300">
            ...
            <a href="{{ route('member.kkprnon.cetak.daftar') }}" target="_blank" class="group relative overflow-hidden bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-4 text-white hover:shadow-lg transition-all duration-300">
                <div class="absolute inset-0 bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div class="relative z-10 text-center">
                    <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center mx-auto mb-3 group-hover:scale-105 transition-transform">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Daftar semua permohonan KKPR Non Usaha</p>
                    </div>
                </div>
                <div class="flex items-center space-x-2">
                    <div class="relative">
            ...
            <div class="divide-y divide-gray-100">
                ...
                <div class="px-6 py-4 hover:bg-gradient-to-r hover:from-[#185B3C]/5 hover:to-transparent transition-all duration-300 group">
                    <div class="grid grid-cols-12 gap-4 items-center">
                        ...
                        <div class="col-span-2">
                            @include('member.kkprnon._proses_berkas', ['model' => $item])
                        </div>
                        <div class="col-span-1">
                            @include('member.kkprnon._action', ['model' => $item])
                        </div>
                    </div>
                </div>
                @empty
                <div class="px-6 py-12 text-center">
                    ...
                    <p class="text-gray-600 mb-6">Anda belum memiliki permohonan KKPR Non Usaha. Mulai buat permohonan pertama Anda.</p>
                    <a href="{{ route('member.kkprnon.create') }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-[#185B3C] to-[#0F3D26] text-white rounded-lg hover:shadow-lg transition-all duration-300">
