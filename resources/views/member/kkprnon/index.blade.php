...
@section('title', 'Permohonan Persetujuan Bagi UMK')
@section('subtitle', 'Kelola semua permohonan persetujuan Persetujuan Bagi UMK Anda')
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-[#185B3C] via-[#0F3D26] to-[#185B3C] rounded-xl p-6 text-white">
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold mb-1">Permohonan Persetujuan Bagi UMK</h1>
                    <p class="text-sm text-white/90 mb-4">Kelola semua permohonan persetujuan Persetujuan Bagi UMK Anda dengan mudah dan efisien</p>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center">
                            ...
                            <p class="text-gray-600 mb-6">Anda belum memiliki Permohonan Persetujuan Bagi UMK. Mulai buat permohonan pertama Anda.</p>
                            <a href="{{ route('member.kkprnon.create') }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-[#185B3C] to-[#0F3D26] text-white rounded-lg hover:shadow-lg transition-all">
                                <i class="fas fa-plus mr-2"></i>
...
<script>
    ...
    function openRiwayat(id) {
        ...
        subtitleDiv.textContent = 'Persetujuan Bagi UMK #' + id;
...
<div id="upload-draft-modal" style="display: none; position: fixed; top: 0; right: 0; bottom: 0; left: 0; z-index: 9999; overflow-y: auto;">
    <div style="display: flex; min-height: 100%; align-items: center; justify-content: center; padding: 1rem;">
        <div style="position: relative; background-color: #ffffff; border-radius: 1rem; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25); max-width: 32rem; width: 100%; transform: translateY(0); transition: all 0.15s;">
            ...
            <!-- Modal Body -->
            <form id="upload-draft-form" action="{{ route('member.kkprnon.upload.draft') }}" method="POST" enctype="multipart/form-data" style="padding: 1.5rem;">
                @csrf
