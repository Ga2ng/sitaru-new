...
@section('subtitle', 'Form edit pengajuan kesesuaian pemanfaatan ruang non usaha')
...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-[#185B3C] via-[#0F3D26] to-[#185B3C] rounded-xl p-6 text-white">
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold mb-1">Edit Permohonan KKPR Non Usaha</h1>
                    <p class="text-sm text-white/90 mb-4">Form edit pengajuan kesesuaian pemanfaatan ruang non usaha</p>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('member.kkprnon.update', $model->id) }}" enctype="multipart/form-data" class="space-y-6" id="kkprForm">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="date" id="tgl_surat" name="tgl_surat" value="{{ old('tgl_surat', $model->tgl_surat) }}" 
                ...
                <div class="space-y-2">
                    ...
                    @if($model->f_nib)
                        <div class="flex items-center space-x-2 p-3 bg-green-50 border border-green-200 rounded-lg mb-2">
                            ...
                            <a href="{{ asset('uploads/berkas/kkpr_non/'.$model->id.'/f_nib/'.$model->f_nib) }}" target="_blank" class="text-blue-600 hover:text-blue-800">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    <label for="sp_mandiri" class="block text-sm font-semibold text-gray-700">
                        ...
                        Upload Surat Pernyataan Mandiri @if(!$model->sp_mandiri)<span class="text-red-500">*.pdf</span>@endif
                    </label>
                    @if($model->sp_mandiri)
                        <div class="flex items-center space-x-2 p-3 bg-green-50 border border-green-200 rounded-lg mb-2">
                            <i class="fas fa-file-pdf text-green-600"></i>
                            <span class="text-sm text-green-700 flex-1">{{ $model->sp_mandiri }}</span>
                            <a href="{{ asset('uploads/berkas/kkpr_non/'.$model->id.'/sp_mandiri/'.$model->sp_mandiri) }}" target="_blank" class="text-blue-600 hover:text-blue-800">
                                <i class="fas fa-eye"></i>
                            </a>
                ...
                <div class="space-y-2">
                    ...
                    @if($model->dok_kepemilikan)
                        <div class="flex items-center space-x-2 p-3 bg-green-50 border border-green-200 rounded-lg mb-2">
                            ...
                            <a href="{{ asset('uploads/berkas/kkpr_non/'.$model->id.'/dokumen_kepemilikan/'.$model->dok_kepemilikan) }}" target="_blank" class="text-blue-600 hover:text-blue-800">
                                <i class="fas fa-eye"></i>
                            </a>
                ...
                <div class="space-y-2">
                    ...
                    @if($model->f_ktp)
                        <div class="flex items-center space-x-2 p-3 bg-green-50 border border-green-200 rounded-lg mb-2">
                            ...
                            <a href="{{ asset('uploads/berkas/kkpr_non/'.$model->id.'/f_ktp/'.$model->f_ktp) }}" target="_blank" class="text-blue-600 hover:text-blue-800">
                                <i class="fas fa-eye"></i>
                            </a>
                ...
                <div class="space-y-2">
                    ...
                    @if($model->f_sertifikat)
                        <div class="flex items-center space-x-2 p-3 bg-green-50 border border-green-200 rounded-lg mb-2">
                            ...
                            <a href="{{ asset('uploads/berkas/kkpr_non/'.$model->id.'/f_sertifikat/'.$model->f_sertifikat) }}" target="_blank" class="text-blue-600 hover:text-blue-800">
                                <i class="fas fa-eye"></i>
                            </a>
                ...
                <div class="space-y-2">
                    ...
                    @if($model->f_siteplan)
                        <div class="flex items-center space-x-2 p-3 bg-green-50 border border-green-200 rounded-lg mb-2">
                            ...
                            <a href="{{ asset('uploads/berkas/kkpr_non/'.$model->id.'/f_siteplan/'.$model->f_siteplan) }}" target="_blank" class="text-blue-600 hover:text-blue-800">
                                <i class="fas fa-eye"></i>
                            </a>
                ...
                <div class="space-y-2">
                    ...
                    @if($model->f_akta)
                        <div class="flex items-center space-x-2 p-3 bg-green-50 border border-green-200 rounded-lg mb-2">
                            ...
                            <a href="{{ asset('uploads/berkas/kkpr_non/'.$model->id.'/f_akta/'.$model->f_akta) }}" target="_blank" class="text-blue-600 hover:text-blue-800">
                                <i class="fas fa-eye"></i>
                            </a>
                ...
                <div class="space-y-2">
                    ...
                    @if($model->dok_taru)
                        <div class="flex items-center space-x-2 p-3 bg-green-50 border border-green-200 rounded-lg mb-2">
                            ...
                            <a href="{{ asset('uploads/berkas/kkpr_non/'.$model->id.'/dok_taru/'.$model->dok_taru) }}" target="_blank" class="text-blue-600 hover:text-blue-800">
                                <i class="fas fa-eye"></i>
                            </a>
                    ...
                    <div class="relative">
                        <input type="file" id="dok_taru" name="dok_taru" accept="application/pdf" 
                               class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 bg-white/80 backdrop-blur-sm file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm font-semibold file:bg-red-50 file:text-red-700 hover:file:bg-red-100">
                    </div>
                    @error('dok_taru')
                        <div class="flex items-center space-x-2 text-red-600 text-sm mt-1">
                            <i class="fas fa-exclamation-circle text-xs"></i>
                        ...
                        <div class="space-y-2 flex-1">
                            ...
                            @if($model->f_kml)
                                <div class="flex items-center space-x-2 p-3 bg-green-50 border border-green-200 rounded-lg mb-2">
                                    ...
                                    <a href="{{ asset('uploads/berkas/kkpr_non/'.$model->id.'/kml/'.$model->f_kml) }}" download class="text-blue-600 hover:text-blue-800" title="Download KML">
            ...
            <div class="space-y-4">
                <div class="flex items-start space-x-3">
                    ...
                    <label for="konfirmasi1" class="text-sm text-gray-700">
                        Bersedia untuk mengikuti ketentuan dan melakukan penyesuaian kepatuhan terhadap ketentuan yang termuat dalam hasil validasi Pernyataan mandiri pelaku Non Usaha
                    </label>
                </div>
        ...
        <div class="flex items-center justify-end space-x-4">
            <a href="{{ route('member.kkprnon.index') }}" class="px-6 py-3 text-gray-700 bg-gray-100 hover:bg-gray-200 font-semibold rounded-xl transition-colors duration-200">
...
<script>
    ...
    function initDynamicForms() {
        ...
        document.addEventListener('click', function(e) {
            if (e.target.classList.contains('btn_remove_kbli') || e.target.parentElement.classList.contains('btn_remove_kbli')) {
                const btn = e.target.classList.contains('btn_remove_kbli') ? e.target : e.target.parentElement;
    ...
    function deleteFile(fieldName, kkprId) {
        ...
        fetch(`/member/kkprnon/${kkprId}/delete-file/${fieldName}`, {
            method: 'DELETE',
            headers: {
        ...
        setTimeout(function() {
            if(window.kkprMap) {
                ...
                if(coordinates.length > 0) {
                    ...
                    document.getElementById('lati_1').value = coordinates[0][0];
                    document.getElementById('longi_1').value = coordinates[0][1];
                }
            }
        }, 1000);
    });
    ...
    // Load existing KML file for edit mode
            ...
            if(window.kkprMap) {
                ...
                fetch(kmlPath)
                    ...
                    .then(kmlText => {
                        ...
                        // Convert KML to GeoJSON
                        const geoJsonData = convertKMLToGeoJSONManual(kmlText);
                        console.log('Existing KML converted to GeoJSON:', geoJsonData);
