            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    <label for="sp_mandiri" class="block text-sm font-semibold text-gray-700">
                        ...
                        Upload Surat Pernyataan Mandiri @if(!isset($model->sp_mandiri) || !$model->sp_mandiri)<span class="text-red-500">*.pdf</span>@endif
                    </label>
...
<script>
    ...
    function toggleInputMethod(method) {
        ...
        // Ensure map renders properly after toggling sections
        setTimeout(function() {
            if (window.kkprMap) {
                window.kkprMap.invalidateSize();
            }
