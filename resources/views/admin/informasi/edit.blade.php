...
@section('subtitle', 'Edit informasi yang sudah ada')
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-[#185B3C] via-[#0F3D26] to-[#185B3C] rounded-xl p-6 text-white">
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold mb-1">Edit Informasi</h1>
                    <p class="text-sm text-white/90 mb-4">Edit informasi "{{ $informasi->nama }}" untuk website</p>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                        ...
                        <div class="text-sm text-gray-600">
                            <p class="font-medium">{{ $informasi->nama }}</p>
                            <p class="text-xs">Gambar saat ini</p>
                        </div>
                    </div>
                </div>
                @endif
                ...
                <div>
                    <label for="photo" class="block text-sm font-medium text-gray-700 mb-2">
                        {{ $informasi->photo ? 'Ganti Gambar' : 'Upload Gambar' }}
                    </label>
                    ...
                    <div class="border-2 border-gray-300 border-dashed rounded-lg hover:border-[#185B3C] transition-colors p-8">
                        <div class="space-y-4 text-center">
                            ...
                            <div class="space-y-2">
                                <div class="text-lg font-medium text-gray-700">
                                    <label for="photo" class="relative cursor-pointer bg-[#185B3C] text-white px-6 py-3 rounded-lg font-medium hover:bg-[#0F3D26] focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-[#185B3C] transition-colors inline-block">
                                        ...
                                        {{ $informasi->photo ? 'Ganti File Gambar' : 'Pilih File Gambar' }}
                                        <input id="photo" name="photo" type="file" class="sr-only" accept="image/jpeg,image/jpg,image/png" onchange="previewImage(this)">
                                    </label>
                                </div>
                            ...
                            <div class="text-xs text-gray-500 space-y-1">
                                ...
                                @if($informasi->photo)
                                <p class="text-blue-600"><strong>Kosongkan jika tidak ingin mengganti gambar</strong></p>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="imagePreview" class="mt-6 hidden">
                        <div class="text-center mb-4">
                            <span class="text-sm font-medium text-gray-700">Preview Gambar Baru:</span>
                        </div>
                ...
                <div>
                    ...
                    <select id="status" 
                        ...
                        <option value="pending" {{ old('status', $informasi->status) == 'pending' ? 'selected' : '' }}>Pending</option>
