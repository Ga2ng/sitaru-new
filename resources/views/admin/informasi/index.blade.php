...
@section('title', 'Informasi Management')
@section('subtitle', 'Kelola semua informasi dan pengumuman website')
...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-[#185B3C] via-[#0F3D26] to-[#185B3C] rounded-xl p-6 text-white">
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold mb-1">Informasi Management</h1>
                    <p class="text-sm text-white/90 mb-4">Kelola semua informasi dan pengumuman website dengan mudah dan efisien</p>
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="text-xs">{{ $totalInformasis }} Total Informasi</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="text-right">
                        <p class="text-2xl font-bold text-[#185B3C]">{{ $totalInformasis }}</p>
                        <p class="text-xs text-gray-500">Total</p>
                    </div>
                </div>
                <h3 class="text-sm font-semibold text-gray-900 mb-1">Total Informasi</h3>
        ...
        <div class="group relative overflow-hidden bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="text-right">
                        <p class="text-2xl font-bold text-green-600">{{ $activeInformasis }}</p>
                        <p class="text-xs text-gray-500">Aktif</p>
                    </div>
                </div>
                <h3 class="text-sm font-semibold text-gray-900 mb-1">Informasi Aktif</h3>
                <div class="flex items-center text-xs text-green-600">
                    <i class="fas fa-arrow-up mr-1"></i>
                    <span>+10% dari kemarin</span>
                </div>
            </div>
        </div>
        ...
        <div class="group relative overflow-hidden bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="text-right">
                        <p class="text-2xl font-bold text-yellow-600">{{ $pendingInformasis }}</p>
                        <p class="text-xs text-gray-500">Pending</p>
                    </div>
                </div>
                <h3 class="text-sm font-semibold text-gray-900 mb-1">Informasi Pending</h3>
        ...
        <div class="group relative overflow-hidden bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="text-right">
                        <p class="text-2xl font-bold text-blue-600">{{ $todayInformasis }}</p>
    ...
    <div class="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20">
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <p class="text-sm text-gray-600">Kelola informasi dengan mudah</p>
            </div>
        ...
        <div class="flex items-center space-x-4">
            <a href="{{ route('admin.informasi.create') }}" class="flex items-center px-4 py-2 text-sm font-medium text-white bg-[#185B3C] rounded-lg hover:bg-[#0F3D26] transition-colors shadow-md">
    ...
    <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 overflow-hidden">
        ...
        <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-900">Daftar Informasi</h3>
                        <p class="text-sm text-gray-600">Kelola semua informasi dan pengumuman</p>
                    </div>
                </div>
                <div class="flex items-center space-x-2">
                    <div class="relative">
                        <input type="text" placeholder="Cari informasi..." class="pl-8 pr-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#185B3C] focus:border-transparent bg-white/80">
            ...
            <div class="px-6 py-3 bg-gray-50/80 border-b border-gray-100">
                <div class="grid grid-cols-12 gap-4">
                    ...
                    <div class="col-span-5">
                        <span class="text-xs font-semibold text-gray-500 uppercase tracking-wider">JUDUL INFORMASI</span>
                    </div>
                    <div class="col-span-2">
            ...
            <div class="divide-y divide-gray-100">
                ...
                <div class="px-6 py-4 hover:bg-gradient-to-r hover:from-[#185B3C]/5 hover:to-transparent transition-all duration-300 group">
                    <div class="grid grid-cols-12 gap-4 items-center">
                        ...
                        <div class="col-span-5">
                            <div>
                                <h5 class="font-semibold text-gray-900 text-sm mb-1">{{ $informasi->nama }}</h5>
                                <p class="text-xs text-gray-500 line-clamp-2">{{ Str::limit($informasi->deskripsi, 100) }}</p>
                                <p class="text-xs text-gray-400 mt-1">Dilihat: {{ $informasi->dilihat ?? 0 }} kali</p>
                            </div>
                        </div>
                        <div class="col-span-2">
                            <p class="text-gray-900 font-medium text-sm">{{ $informasi->updated_at->format('d M Y') }}</p>
                            <p class="text-xs text-gray-500">{{ $informasi->updated_at->format('H:i') }}</p>
                        </div>
                        <div class="col-span-1">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" class="sr-only peer" {{ $informasi->status === 'aktif' ? 'checked' : '' }}
                                       onchange="toggleInformasiStatus({{ $informasi->id }}, this.checked)">
                                <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                            </label>
                        </div>
                        <div class="col-span-1">
                            <div class="flex items-center justify-center space-x-1">
                                <a href="{{ route('admin.informasi.show', $informasi->id) }}" class="p-2 text-gray-400 hover:text-[#185B3C] hover:bg-[#185B3C]/10 rounded-lg transition-all duration-200 hover:scale-105" title="Lihat Detail">
                                    <i class="fas fa-eye text-xs"></i>
                                </a>
                                <a href="{{ route('admin.informasi.edit', $informasi->id) }}" class="p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all duration-200 hover:scale-105" title="Edit Informasi">
                                ...
                                <form action="{{ route('admin.informasi.destroy', $informasi->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this informasi?');" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all duration-200 hover:scale-105" title="Hapus Informasi">
                ...
                <div class="px-6 py-8 text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Tidak ada informasi</h3>
                    <p class="text-gray-500 mb-4">Belum ada informasi yang dibuat.</p>
                    <a href="{{ route('admin.informasi.create') }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-[#185B3C] rounded-lg hover:bg-[#0F3D26] transition-colors">
                        <i class="fas fa-plus mr-2"></i>
        ...
        <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-t border-gray-200">
            <div class="flex items-center justify-between">
                <p class="text-sm text-gray-600">Menampilkan <span class="font-semibold text-[#185B3C]">{{ $informasis->count() }}</span> dari <span class="font-semibold text-[#185B3C]">{{ $informasis->total() }}</span> informasi</p>
...
<script>
    function toggleInformasiStatus(informasiId, status) {
        const newStatus = status ? 'aktif' : 'pending';
        
        fetch(`/admin/informasi/${informasiId}/toggle-status`, {
            method: 'POST',
            headers: {
