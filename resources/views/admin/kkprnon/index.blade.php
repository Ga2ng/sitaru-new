                    ...
                    <div class="grid grid-cols-12 gap-4 items-center">
                        ...
                        <div class="col-span-1">
                            <div class="flex items-center space-x-1">
                                <a href="{{ route('admin.kkprnon.show', $kkpr->id) }}" class="p-2 text-gray-400 hover:text-[#185B3C] hover:bg-[#185B3C]/10 rounded-lg transition-all duration-200 hover:scale-105" title="Lihat Detail">
                                    <i class="fas fa-eye text-xs"></i>
                                </a>
                                <a href="{{ route('admin.kkprnon.edit', $kkpr->id) }}" class="p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all duration-200 hover:scale-105" title="Edit">
