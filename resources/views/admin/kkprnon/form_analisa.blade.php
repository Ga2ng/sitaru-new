...
@section('title', 'Form Analisa Persetujuan Bagi UMK')
...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('admin.kkprnon.analisa.store') }}" enctype="multipart/form-data" class="space-y-6" id="analisaForm">
        @csrf
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20">
            <div class="flex items-center space-x-3 mb-6">
                ...
                <h3 class="text-lg font-bold text-gray-900">1. Persetujuan Kegiatan Pemanfaatan Ruang Bagi Persetujuan Bagi UMK</h3>
            </div>
    ...
    function hapusDok(id, field) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch('{{ route("admin.kkprnon.hapus.dokumen") }}', {
                    method: 'POST',
                    headers: {
    ...
    function tolakDokumen(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch('{{ route("admin.kkprnon.tolak.dokumen") }}', {
                    method: 'POST',
                    headers: {
                        ...
                        Swal.fire({
                            ...
                            html: `
                                <div class="text-left space-y-2">
                                    <p class="text-sm text-gray-700">Permohonan KKPR Non telah <strong class="text-red-600">DITOLAK</strong> dan tidak dapat diproses lebih lanjut.</p>
