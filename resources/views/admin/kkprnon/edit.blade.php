...
@section('title', 'Edit KKPR Non - ' . $model->id)
@section('subtitle', 'Edit form penilaian KKPR terbit otomatis')
...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-[#185B3C] via-[#0F3D26] to-[#185B3C] rounded-xl p-6 text-white">
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold mb-1">Edit KKPR Non #{{ $model->id }}</h1>
                    <p class="text-sm text-white/90 mb-4">Edit form penilaian KKPR terbit otomatis</p>
                </div>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('admin.kkprnon.update', $model->id) }}" enctype="multipart/form-data" class="space-y-6">
        @csrf
        @method('PUT')
