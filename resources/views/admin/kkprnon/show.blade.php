                ...
                <div class="bg-gradient-to-r from-indigo-50 to-indigo-100 rounded-lg p-6">
                    ...
                    <div class="bg-white rounded-lg p-4 border border-indigo-200">
                        ...
                        <div class="mt-4 flex items-center space-x-4">
                            <a href="{{ route('admin.kkprnon.peta', $model->id) }}" class="inline-flex items-center px-4 py-2 bg-indigo-500 text-white rounded-lg hover:bg-indigo-600 transition-colors">
