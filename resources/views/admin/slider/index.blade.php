...
@section('subtitle', 'Kelola semua slider dan banner website')
...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-[#185B3C] via-[#0F3D26] to-[#185B3C] rounded-xl p-6 text-white">
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold mb-1">Slider Management</h1>
                    <p class="text-sm text-white/90 mb-4">Kelola semua slider dan banner website dengan mudah dan efisien</p>
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="text-right">
                        <p class="text-2xl font-bold text-[#185B3C]">{{ $totalSliders }}</p>
                        <p class="text-xs text-gray-500">Total</p>
                    </div>
                </div>
                <h3 class="text-sm font-semibold text-gray-900 mb-1">Total Slider</h3>
        ...
        <div class="group relative overflow-hidden bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="text-right">
                        <p class="text-2xl font-bold text-green-600">{{ $activeSliders }}</p>
                        <p class="text-xs text-gray-500">Aktif</p>
                    </div>
                </div>
                <h3 class="text-sm font-semibold text-gray-900 mb-1">Slider Aktif</h3>
                <div class="flex items-center text-xs text-green-600">
                    <i class="fas fa-arrow-up mr-1"></i>
        ...
        <div class="group relative overflow-hidden bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="text-right">
                        <p class="text-2xl font-bold text-red-600">{{ $inactiveSliders }}</p>
                        <p class="text-xs text-gray-500">Nonaktif</p>
                    </div>
                </div>
                <h3 class="text-sm font-semibold text-gray-900 mb-1">Slider Nonaktif</h3>
        ...
        <div class="group relative overflow-hidden bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="text-right">
                        <p class="text-2xl font-bold text-blue-600">{{ $todaySliders }}</p>
    ...
    <div class="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20">
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <p class="text-sm text-gray-600">Kelola slider dengan mudah</p>
            </div>
        ...
        <div class="flex items-center space-x-4">
            <a href="{{ route('admin.slider.create') }}" class="flex items-center px-4 py-2 text-sm font-medium text-white bg-[#185B3C] rounded-lg hover:bg-[#0F3D26] transition-colors shadow-md">
    ...
    <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 overflow-hidden">
        ...
        <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-900">Daftar Slider</h3>
                        <p class="text-sm text-gray-600">Kelola semua slider dan banner</p>
                    </div>
                </div>
                <div class="flex items-center space-x-2">
                    <div class="relative">
                        <input type="text" placeholder="Cari slider..." class="pl-8 pr-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#185B3C] focus:border-transparent bg-white/80">
            ...
            <div class="px-6 py-3 bg-gray-50/80 border-b border-gray-100">
                <div class="grid grid-cols-12 gap-4">
                    ...
                    <div class="col-span-4">
                        <span class="text-xs font-semibold text-gray-500 uppercase tracking-wider">JUDUL SLIDER</span>
                    </div>
                    <div class="col-span-2">
                        <span class="text-xs font-semibold text-gray-500 uppercase tracking-wider">LINK</span>
                    </div>
                    <div class="col-span-1">
            ...
            <div class="divide-y divide-gray-100">
                ...
                <div class="px-6 py-4 hover:bg-gradient-to-r hover:from-[#185B3C]/5 hover:to-transparent transition-all duration-300 group">
                    <div class="grid grid-cols-12 gap-4 items-center">
                        ...
                        <div class="col-span-4">
                            <div>
                                <p class="font-semibold text-gray-900 text-sm">{{ $slider->judul }}</p>
                                <p class="text-xs text-gray-500">Dibuat: {{ $slider->created_at->format('d M Y') }}</p>
                            </div>
                        </div>
                        <div class="col-span-2">
                            @if($slider->link)
                                <a href="{{ $slider->link }}" target="_blank" class="text-blue-600 hover:text-blue-800 text-sm truncate block">
                        ...
                        <div class="col-span-1">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" class="sr-only peer" {{ $slider->status ? 'checked' : '' }}
                        ...
                        <div class="col-span-2">
                            <div class="flex items-center justify-center space-x-1">
                                <a href="{{ route('admin.slider.show', $slider->id) }}" class="p-2 text-gray-400 hover:text-[#185B3C] hover:bg-[#185B3C]/10 rounded-lg transition-all duration-200 hover:scale-105" title="Lihat Detail">
                                    <i class="fas fa-eye text-xs"></i>
                                </a>
                                <a href="{{ route('admin.slider.edit', $slider->id) }}" class="p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all duration-200 hover:scale-105" title="Edit Slider">
                                ...
                                <form action="{{ route('admin.slider.destroy', $slider->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this slider?');" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all duration-200 hover:scale-105" title="Hapus Slider">
                ...
                <div class="px-6 py-8 text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Tidak ada slider</h3>
                    <p class="text-gray-500 mb-4">Belum ada slider yang dibuat.</p>
                    <a href="{{ route('admin.slider.create') }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-[#185B3C] rounded-lg hover:bg-[#0F3D26] transition-colors">
                        <i class="fas fa-plus mr-2"></i>
        ...
        <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-t border-gray-200">
            <div class="flex items-center justify-between">
                <p class="text-sm text-gray-600">Menampilkan <span class="font-semibold text-[#185B3C]">{{ $sliders->count() }}</span> dari <span class="font-semibold text-[#185B3C]">{{ $sliders->total() }}</span> slider</p>
...
<script>
    function toggleSliderStatus(sliderId, status) {
        fetch(`/admin/slider/${sliderId}/toggle-status`, {
            method: 'POST',
            headers: {
