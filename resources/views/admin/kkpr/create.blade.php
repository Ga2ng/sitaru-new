...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('admin.kkpr.store') }}" enctype="multipart/form-data" class="space-y-6" id="kkprForm">
        @csrf
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <!-- Dynamic Field untuk Kondisi Lahan Eksisting lainnya -->
...
{{-- 
                ...
                <div class="space-y-2">
                    <label for="sp_mandiri" class="block text-sm font-semibold text-gray-700">
                        <i class="fas fa-file-signature mr-2 text-orange-600"></i>
