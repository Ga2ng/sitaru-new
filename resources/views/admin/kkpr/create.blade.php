...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('admin.kkpr.store') }}" enctype="multipart/form-data" class="space-y-6">
        @csrf
                ...
                <div class="space-y-2">
                    ...
                    <select id="kabupaten_id" name="kabupaten_id" 
                        ...
                        @foreach($kabupaten as $id => $name)
                            <option value="{{ $id }}" {{ old('kabupaten_id') == $id ? 'selected' : '' }}>{{ $name }}</option>
                        @endforeach
                    </select>
                    @error('kabupaten_id')
                        <div class="flex items-center space-x-2 text-red-600 text-sm mt-1">
                ...
                <div class="space-y-2">
                    ...
                    <select id="kecamatan_id" name="kecamatan_id" 
                        ...
                        @foreach($kecamatan as $id => $name)
                            <option value="{{ $id }}" {{ old('kecamatan_id') == $id ? 'selected' : '' }}>{{ $name }}</option>
                        @endforeach
                    </select>
                    @error('kecamatan_id')
                        <div class="flex items-center space-x-2 text-red-600 text-sm mt-1">
                ...
                <div class="space-y-2">
                    ...
                    <select id="kelurahan_id" name="kelurahan_id" 
                        ...
                        @foreach($kelurahan as $id => $name)
                            <option value="{{ $id }}" {{ old('kelurahan_id') == $id ? 'selected' : '' }}>{{ $name }}</option>
                        @endforeach
                    </select>
                    @error('kelurahan_id')
                        <div class="flex items-center space-x-2 text-red-600 text-sm mt-1">
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" id="jenis_kegiatan" name="jenis_kegiatan" value="{{ old('jenis_kegiatan') }}" 
                           class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 bg-white/80 backdrop-blur-sm" 
