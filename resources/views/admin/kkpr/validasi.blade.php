        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-semibold text-gray-600">Nama Badan Usaha</p>
                        <p class="text-sm text-gray-900">{{ $model->nama_usaha ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-semibold text-gray-600">Jabatan Pemohon</p>
                        <p class="text-sm text-gray-900">{{ $model->jabatan_pemohon ?? 'N/A' }}</p>
                    </div>
                </div>
                @endif
            </div>
        ...
        <div class="xl:col-span-2 space-y-6">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20">
                <div class="flex items-center space-x-3 mb-6">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-900">Data Pengajuan Kegiatan</h3>
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 mt-1">
                                        @if($model->jenis_kegiatan == 'Lainnya')
                                            {{ $model->jenis_kegiatan_lainnya ?? 'N/A' }}
                                        @else
                                            {{ $model->jenis_kegiatan ?? 'N/A' }}
                                        @endif
                                    </p>
                                </div>
                                <div>
                    ...
                    <div class="space-y-4">
                        <div class="bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg p-4">
                            <div class="space-y-3">
                                ...
                                <div>
                                    <label class="text-sm font-semibold text-gray-600">Status Lahan</label>
                                    <p class="text-gray-900 mt-1">{{ is_array($model->status_lahan) ? implode(', ', $model->status_lahan) : ($model->status_lahan ?? 'N/A') }}</p>
                                </div>
                                <div>
                                    <label class="text-sm font-semibold text-gray-600">Status Penggunaan Tanah</label>
                                    <p class="text-gray-900 mt-1">{{ is_array($model->status_penggunaan_tanah) ? implode(', ', $model->status_penggunaan_tanah) : ($model->status_penggunaan_tanah ?? 'N/A') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                    <div class="bg-gradient-to-r from-orange-50 to-orange-100 rounded-lg p-4">
                        <label class="text-sm font-semibold text-gray-600">Status Atas Tanah</label>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 overflow-hidden">
                ...
                <div class="divide-y divide-gray-100">
                    <!-- Surat Kepemilikan -->
                    <div class="px-6 py-4 hover:bg-gradient-to-r hover:from-[#185B3C]/5 hover:to-transparent transition-all">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                <i class="fas fa-file-contract text-[#185B3C] text-lg"></i>
                                <span class="font-medium text-gray-900">Surat Kepemilikan Tanah</span>
                            </div>
                            <div>
                    ...
                    <div class="px-6 py-4 hover:bg-gradient-to-r hover:from-purple-50 hover:to-transparent transition-all">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="font-medium text-gray-900">Sertifikat Tanah</span>
                            </div>
                            <div>
                    ...
                    <div class="px-6 py-4 hover:bg-gradient-to-r hover:from-orange-50 hover:to-transparent transition-all">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                <i class="fas fa-map text-orange-600 text-lg"></i>
                                <span class="font-medium text-gray-900">Siteplan/Denah Lokasi</span>
                            </div>
                            <div>
                    ...
                    <div class="px-6 py-4 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-transparent transition-all">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="font-medium text-gray-900">Akta Perusahaan</span>
                            </div>
                            <div>
                    ...
                    <div class="px-6 py-4 hover:bg-gradient-to-r hover:from-pink-50 hover:to-transparent transition-all">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                <i class="fas fa-map-marked-alt text-pink-600 text-lg"></i>
                                <span class="font-medium text-gray-900">KML File</span>
                            </div>
                            <div>
                                @if ($model->f_kml != null)
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 overflow-hidden">
                <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900">Surat Pernyataan Mandiri</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-gray-900 mt-1">{{ $model->tgl_terbit ?? 'N/A' }}</p>
                        </div>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 overflow-hidden">
                <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900">NIB (Nomor Induk Berusaha)</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            <label class="text-sm font-semibold text-gray-600">Nomor NIB</label>
                            <p class="text-gray-900 mt-1 font-mono">{{ $model->no_nib ?? 'N/A' }}</p>
                        </div>
                        <div class="flex-1 text-right">
                            @if ($model->f_nib != null)
...
<script>
    ...
    function validasi_dokumen(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch('{{ route("admin.kkpr.validasi.store") }}', {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                        'Content-Type': 'application/json',
    ...
    function open_koordinat(id) {
        ...
        modal.modal('show');
        $.ajax({
            url: '{{ route("admin.kkpr.koordinat", "") }}/' + id,
            type: "GET",
            dataType: "html",
