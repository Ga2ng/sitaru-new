...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-[#185B3C] via-[#0F3D26] to-[#185B3C] rounded-xl p-6 text-white">
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold mb-1">Kelengkapan Kependudukan</h1>
                    <p class="text-sm text-white/90 mb-4">Kelola semua permohonan kependudukan Anda dengan mudah dan efisien</p>
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="text-right">
                        <p class="text-2xl font-bold text-[#185B3C]">24</p>
    ...
    <div class="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <button class="group relative overflow-hidden bg-gradient-to-br from-[#185B3C] to-[#0F3D26] rounded-xl p-4 text-white hover:shadow-lg transition-all duration-300">
            ...
            <button class="group relative overflow-hidden bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-4 text-white hover:shadow-lg transition-all duration-300">
                ...
                <div class="relative z-10 text-center">
                    ...
                    <h4 class="font-semibold text-sm mb-1">Lihat Dokumen</h4>
                    <p class="text-xs text-white/80">Akses dokumen Anda</p>
                </div>
            </button>
    ...
    <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 overflow-hidden">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Daftar semua permohonan kependudukan</p>
                    </div>
                </div>
                <div class="flex items-center space-x-2">
                    <div class="relative">
            ...
            <div class="px-6 py-3 bg-gray-50/80 border-b border-gray-100">
                <div class="grid grid-cols-12 gap-4">
                    <div class="col-span-4">
                        <span class="text-xs font-semibold text-gray-500 uppercase tracking-wider">JENIS LAYANAN</span>
                    </div>
                    <div class="col-span-2">
                        <span class="text-xs font-semibold text-gray-500 uppercase tracking-wider">NO. PERMOHONAN</span>
                    </div>
                    <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-12 gap-4 items-center">
                        <div class="col-span-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="font-bold text-gray-900 text-sm">Kartu Keluarga</p>
                                    <p class="text-xs text-gray-500">Add • 24 Sep 2024</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-2">
                            <p class="font-semibold text-gray-900 text-sm">#KKPR-001</p>
                            <p class="text-xs text-gray-500">24 Sep 2024</p>
                        </div>
                        <div class="col-span-2">
                            <p class="text-gray-900 font-medium text-sm">24 Sep 2024</p>
                        ...
                        <div class="col-span-2">
                            <div class="flex items-center space-x-1">
                                <button class="p-2 text-gray-400 hover:text-[#185B3C] hover:bg-[#185B3C]/10 rounded-lg transition-all duration-200 hover:scale-105" title="Lihat Detail">
                                    <i class="fas fa-eye text-xs"></i>
                                </button>
                                <button class="p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all duration-200 hover:scale-105" title="Edit">
                                    <i class="fas fa-edit text-xs"></i>
                                </button>
                                <button class="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all duration-200 hover:scale-105" title="Hapus">
                    ...
                    <div class="grid grid-cols-12 gap-4 items-center">
                        <div class="col-span-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="font-bold text-gray-900 text-sm">KTP</p>
                                    <p class="text-xs text-gray-500">Sent • 23 Sep 2024</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-2">
                            <p class="font-semibold text-gray-900 text-sm">#KKPR-002</p>
                            <p class="text-xs text-gray-500">23 Sep 2024</p>
                        </div>
                        <div class="col-span-2">
                            <p class="text-gray-900 font-medium text-sm">23 Sep 2024</p>
                            <p class="text-xs text-gray-500">14:15 WIB</p>
                        </div>
                        <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-12 gap-4 items-center">
                        <div class="col-span-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="font-bold text-gray-900 text-sm">Akta Kelahiran</p>
                                    <p class="text-xs text-gray-500">Complete • 22 Sep 2024</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-2">
                            <p class="font-semibold text-gray-900 text-sm">#KKPR-003</p>
                            <p class="text-xs text-gray-500">22 Sep 2024</p>
                        </div>
                        <div class="col-span-2">
                            <p class="text-gray-900 font-medium text-sm">22 Sep 2024</p>
                            <p class="text-xs text-gray-500">09:45 WIB</p>
                        </div>
                        <div class="col-span-2">
                            <span class="inline-flex px-3 py-1 text-xs font-semibold rounded-full bg-gradient-to-r from-green-100 to-green-200 text-green-800 border border-green-300">
                                <i class="fas fa-check-circle mr-1 text-xs"></i>
                    ...
                    <div class="grid grid-cols-12 gap-4 items-center">
                        <div class="col-span-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="font-bold text-gray-900 text-sm">Kartu Identitas Anak</p>
                                    <p class="text-xs text-gray-500">Pending • 21 Sep 2024</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-2">
                            <p class="font-semibold text-gray-900 text-sm">#KKPR-004</p>
                            <p class="text-xs text-gray-500">21 Sep 2024</p>
                        </div>
                        <div class="col-span-2">
                            <p class="text-gray-900 font-medium text-sm">21 Sep 2024</p>
        ...
        <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-t border-gray-200">
            <div class="flex items-center justify-between">
                <p class="text-sm text-gray-600">Menampilkan <span class="font-semibold text-[#185B3C]">4</span> dari <span class="font-semibold text-[#185B3C]">24</span> permohonan</p>
                <div class="flex items-center space-x-1">
                    <button class="px-3 py-1 text-sm text-gray-600 hover:text-gray-900 hover:bg-white/80 rounded-lg transition-colors">
                        <i class="fas fa-chevron-left mr-1 text-xs"></i>
                        Previous
                    </button>
                    <button class="px-3 py-1 text-sm bg-[#185B3C] text-white rounded-lg shadow-md">
                        1
                    </button>
                    <button class="px-3 py-1 text-sm text-gray-600 hover:text-gray-900 hover:bg-white/80 rounded-lg transition-colors">
                        2
