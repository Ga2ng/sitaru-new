...
class AdminKkprController extends Controller
{
    ...
    public function analisa($id)
    {
        ...
        if (empty($model->no_sk)) {
            $lastKkpr = Kkpr::whereNotNull('no_sk')
                ->where('no_sk', '!=', '')
                ->orderBy('id', 'desc')
                ->first();
        ...
        try {
            ...
            if (!$riwayat) {
                Kkpr_riwayat::create([
                    ...
                    'status_id' => '7',
                    'status' => 'Analisa',
                    'keterangan' => 'Data KKPR telah dianalisa oleh analis'
                ]);
            } else {
                $riwayat->update([
                    'keterangan' => 'Data KKPR telah diupdate oleh analis'
                ]);
            }
    ...
    public function cetakBerkasKkpr($id)
    {
        try {
            ...
            $pdf = Pdf::loadView('admin.kkpr.pdf.berkas-kkpr', $data)
