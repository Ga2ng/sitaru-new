...
class Krk_sipo extends Model
{
    use HasFactory;

    protected $table = 'krk_sipo';
    protected $fillable = ['kategori_id', 'user_id', 'no_krk', 'tgl_surat', 'alamat_tanah', 'kabupaten_id', 'kecamatan_id', 'kelurahan_id', 'luas', 'jns_sertifikat', 'thn_sertifikat', 'no_sertifikat', 'an_sertifikat', 'luas_sertifikat', 'penggunaan_awal', 'penggunaan_baru', 'foto_barat', 'foto_timur', 'foto_utara', 'foto_selatan', 'longitude', 'lattitude', 'tgl_terima', 'penerima', 'tgl_kembali', 'penerima_kembali', 'ket_terima', 'tgl_terbit', 'status_permohonan', 'keterangan', 'berkas_jadi', 'tgl_tl', 'petugas_tl', 'petugas_id', 'ktp_pemilik', 'kepimilikan', 'nama_pemilik', 'umur_pemilik', 'alamat_pemilik', 'pekerjaan_pemilik', 'jam_terima', 'jam_kembali','tte','berkas_draft','output','status','zona', 'sub_zona', 'sesuai', 'bts_kdb', 'bts_gsb', 'bts_rth', 'bts_klb', 'gbr_lokasi', 'rt', 'rw', 'no_reg','paraf','proses','revisi','deleted'];
    ...
    protected function casts(): array
    {
        return [
            ...
            return url('uploads/berkas/krk_sipo/' . $this->id .'/'. $this->foto_utara);
    ...
    protected function casts(): array
    {
        return [
            ...
            return url('uploads/berkas/krk_sipo/' . $this->id .'/'. $this->foto_selatan);
    ...
    protected function casts(): array
    {
        return [
            ...
            return url('uploads/berkas/krk_sipo/' . $this->id .'/'. $this->foto_barat);
    ...
    protected function casts(): array
    {
        return [
            ...
            return url('uploads/berkas/krk_sipo/' . $this->id .'/'. $this->foto_timur);
